...
let sensorsMap = {}
allSensors.map(item => { sensorsMap[item.id] = item })
export default {
  allSensors,
  alarmTypes,
  ...
  getAlarmText: function (type) {
    ...
    let result = alarmTypes.find((alarm) => { return alarm.type === type + '' })
  ...
  getAllSensors: function () {
    return allSensors.map((sensor) => { return {id: sensor.id, name: sensor.name} })
  }
}
